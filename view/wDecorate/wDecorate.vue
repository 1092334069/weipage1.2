<template>
	<div :id="pluginData.identity" class="plugin_wrap" :style="parseDecorateStyle(pluginData.backgroundColor,pluginData.backgroundImage,pluginData.width,pluginData.height,pluginData.top,pluginData.left,pluginData.borderRadius)">
		<div class="decorate_wrap"></div>
	</div>
</template>
