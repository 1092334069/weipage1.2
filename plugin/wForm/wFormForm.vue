<template>
	<div>
		...
		<div class="yui_form_wrap">
			<p class="input_lable">表单列表：</p>
			<div class="input_wrap">
				<span v-for="item in pluginData.subPluginList" class="childPlugin_wrap childPlugin_lable subPlugin_wrap drop_wrap drop_copy_wrap" :class="{current:item.pluginSelect}" :data-plugInUuid="item.pluginUuid">{{item.title}}</span>
