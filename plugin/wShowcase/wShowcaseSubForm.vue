<template>
	<div>
		...
		<div class="childPlugin_option_page">		
			...
			<div class="yui_form_wrap">
				<p class="input_lable">副标题：</p>
				<div class="input_wrap">													
					<div class="form_one">
						<input type="text" class="input_text float_left size_l_m" name="subName" placeholder="" :value="subPluginData.subName" />	
					</div>
				</div>
			</div>
			<div class="yui_form_wrap">
