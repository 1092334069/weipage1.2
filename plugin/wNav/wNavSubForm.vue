		...
		<div class="childPlugin_option_page">
			<div class="yui_form_wrap">
				...
				<div class="input_wrap">	
					<div class="form_one">{{subPluginData.identity}}</div>
				</div>
			</div>		
			<div v-if="pluginData.subPluginType == 'IMAGE'" class="yui_form_wrap">
				<p class="input_lable">导航图片：</p>
				<div class="input_wrap">							
					<div class="image_wrap float_left">
						<div class="upload_image image_item" data-action="true" >
							<img class="image_view" :src="subPluginData.picUrl" />
			...
			<div class="yui_form_wrap">
				...
				<div class="input_wrap">													
					<div class="form_one">
						<input type="text" class="input_text float_left size_l_m" name="name" placeholder="" :value="subPluginData.name" />	
					</div>
				</div>
			</div>	
			<div class="yui_form_wrap">
				...
				<div class="input_wrap">													
					<div class="form_one">
						<select class="float_left" name="functionCode">
			...
			<div v-if="subPluginData.linkType == 'CUSTOM'" class="yui_form_wrap">
				...
				<div class="input_wrap">	
					<div class="form_one">
						<input type="text" class="input_text float_left size_l_m" name="linkUrl" placeholder="" :value="subPluginData.linkUrl" />	
					</div>
				</div>
			</div>
